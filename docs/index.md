...
* **Порядок уровней** — позволяет инвертировать индикацию в карточках виджетов при переключении уровней нагрева от большего к меньшему *(подобно автомобилям VAG)*. Если в пользовательском режиме включить инвертированный порядок и настроить так, что 1-й уровень мощнее 3-го, то при включении 1-го уровня в карточке виджета будут отображаться сразу 3 активных светодиода, а на 3-ем уровне — только 1.
