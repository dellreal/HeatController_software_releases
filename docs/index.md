...
### 3.1.1. Внешний вид
![](attachment/3e31588f70daeceec6561a9c682e71e8.png)

Здесь можно изменить язык приложения и тему оформления. Так же если в разделе "Виджеты" включено отображение системного виджета, то можно настроить стиль его элементов (прозрачность виджета единая для темной и светлой тем оформления ГУ, а настройки цвета индивидуальны для каждой темы).
